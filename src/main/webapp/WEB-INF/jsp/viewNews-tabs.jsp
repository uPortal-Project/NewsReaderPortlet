    ...
    <div id="${n}">
        <div class="news-reader-feed-list portlet ptl-newsreader view-news">
            <div class="news-feeds-container">
                <div data-role="content" class="portlet-content tabs">
                    <ul class="news-feeds" data-role="listview">
                        <li class="news-feed">
                            <a href="javascript:;" class="news-feed-link" title="newsTab">
                                <span class="news-feed-name"></span>
                            </a>
                        </li>
                    </ul>         

                    <div id="newsTab" class="news-stories-container" style="display:none;">
...
<rs:aggregatedResources path="${ usePortalJsLibs ? '/skin-tabs-shared.xml' : '/skin-tabs.xml' }"/>
